...
import CommentCreate, {GuestMessage} from '../comment_create';

describe('comments.components.comment_create', () => {
  describe('if guest (!loggedIn)', () => {
    it('should define guest message', () => {
      expect(GuestMessage.props.children).to.match(/create a comment/);
    });
  });

  describe('if loggedIn', () => {
